 ...
 */
export default function downloadAsImageSVG(
  selector: string,
  description: string,
...
// Redefinice ukladani primo do SVG misto JPG
// Roman Vaibar dne 20240607 
    return domToImage
...
//        link.download = `${generateFileStem(description)}.jpg`;
        link.download = `${generateFileStem(description)}.svg`;
        link.href = dataUrl;
        link.click();
      })
      .catch((e: Error) => {
